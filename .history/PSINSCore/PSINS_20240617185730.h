...
/**
 * @brief 捷联惯导组合时间分散滤波算法,继承自CSINSKF类，引入该类的目的为了使算法能在嵌入式系统上实时应用。
 * 
 */
...
{
public:
	double t, tk, ts, T1, T2;//!内部计算时间t，与惯组采样时刻对应的对准时间tk，ts采样间隔，粗对准时间T1，精对准时间T2
	BOOL alnkfinit; //!粗对准完成，进入kf精对准标识
	CAligni0 alni0; //!惯性系粗对准方法
	CRMemory *pMem; //!惯性数据存储指针
